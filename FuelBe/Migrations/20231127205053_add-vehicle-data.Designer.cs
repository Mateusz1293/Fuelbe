...
namespace FuelBe.Migrations
{
    ...
    [Migration("20231127205053_add-vehicle-data")]
            ...
            modelBuilder.Entity("FuelBe.Database.Models.Vehicle", b =>
                {
                    ...
                    b.Property<DateTime>("InspectionTo")
                        .HasColumnType("datetime2")
                        .HasColumnName("inspection_to");

                    b.Property<DateTime>("InsuranceTo")
                        .HasColumnType("datetime2")
                        .HasColumnName("insurance_to");
                    ...
                    b.Property<string>("TiresType")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("tires_type");
